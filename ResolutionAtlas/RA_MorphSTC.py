...
Runs in mnedev environment.
e.g.: run WH_Res_MorphSTC_mnedev.py WH_Res_config 11 SensitivityMaps SensMap RMS
or: run WH_Res_MorphSTC_mnedev.py WH_Res_config 11 ResolutionMetrics locerr_peak
=========================================================
